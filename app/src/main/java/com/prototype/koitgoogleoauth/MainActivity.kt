package com.prototype.koitgoogleoauth
...
import com.prototype.koitgoogleoauth.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        //Result returned from launching the Intent from GoogleSignInApi.getASignInIntent(...);
    ...
    private fun firebaseAuthWithGoogleAccount(account: GoogleSignInAccount?){
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnSuccessListener { authResult ->
                    ...
                    //check if user is new orexisting
